...
from fxdayu_dataz.adjust.blp_reader import ExFactor
import six
...
class AdjustWriter(object):
    ...
    @classmethod
    def env(cls):
        from fxdayu_dataz.adjust.env import get_db
    ...
    def __call__(self, fields=None):
        if fields is None:
            from fxdayu_dataz.IO.config import get_codes, STOCK
...
def generate():
    import click
    from fxdayu_dataz.utils.field import FIELD_OPTION
