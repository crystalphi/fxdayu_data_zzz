...
from fxdayu_dataz.IO.freq import Freq
from fxdayu_dataz.utils.field import START_OPTION_EMPTY, END_OPTION_EMPTY
import click
import os
...
def create_config(root_dir):
    from fxdayu_dataz.IO.config import STORAGE, FILES, CODES, path, root
